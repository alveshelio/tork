...
export default class Result implements postcss.Result {
    ...
    root: Root;
    /**
     * Options from the Processor#process(styles, opts) or Root#toResult(opts) call
    ...
    /**
     * Alias for styles property to use with syntaxes that generate non-CSS output.
     */
    content: string;
}
