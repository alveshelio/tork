...
<!-- include the default Javascript (jQuery and Modernizr) -->
    <script src="../libs/modernizr-2.0.6.min.js" charset="utf-8"></script>
...
<body>
    <ul id="nav">
        ...
        <li><strong>Example using Modernizr</strong></li>
...
<!-- this is where the Magic happens — we feature test for placeholder support and load the polyfill if needed -->
    ...
    // remove/add the second slash in the following line to toggle between production and dev block
        ...
        Modernizr.load({
            ...
            nope: [
                    '../libs/onfontresize.jquery.min.js', // optional
                    '../libs/jquery.ba-resize.min.js', // optional
                    '../src/placeholder_polyfill.css',
                    '../src/placeholder_polyfill.jquery.js', // this and the styles above are the only required files
                  ]
        });
...
<!-- ignore from here on -->
    ...
    <a href="https://github.com/ginader/HTML5-placeholder-polyfill"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png" alt="Fork me on GitHub"></a>
