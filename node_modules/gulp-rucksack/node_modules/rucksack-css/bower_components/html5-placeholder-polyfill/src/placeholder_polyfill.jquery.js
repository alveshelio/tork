...
(function($) {
    ...
    $.fn.placeHolder = function(config) {
        ...
        var l = $(this).length;
        this.options = $.extend({
            className: 'placeholder', // styles class that is used to style the placeholder
            visibleToScreenreaders : true, // expose the placeholder text to screenreaders or not
            visibleToScreenreadersHideClass : 'placeholder-hide-except-screenreader', // styles class is used to visually hide the placeholder
            visibleToNoneHideClass : 'placeholder-hide', // styles class used to hide the placeholder for all
