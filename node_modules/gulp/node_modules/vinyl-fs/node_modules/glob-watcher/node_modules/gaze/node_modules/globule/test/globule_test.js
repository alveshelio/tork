...
exports['find'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(globule.find('**/*.js', '**/*.css'),
      ['js/bar.js', 'js/foo.js', 'styles/baz.css', 'styles/qux.css'],
  ...
  'file order': function(test) {
    test.expect(5);
    var actual = globule.find('**/*.{js,styles}');
    var expected = ['styles/baz.css', 'styles/qux.css', 'js/bar.js', 'js/foo.js'];
    test.deepEqual(actual, expected, 'should select 4 files in this order, by default.');

    actual = globule.find('js/foo.js', 'js/bar.js', '**/*.{js,styles}');
    expected = ['js/foo.js', 'js/bar.js', 'styles/baz.css', 'styles/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = globule.find('js/bar.js', 'js/foo.js', '**/*.{js,styles}');
    expected = ['js/bar.js', 'js/foo.js', 'styles/baz.css', 'styles/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = globule.find('**/*.{js,styles}', '!styles/qux.css', 'styles/qux.css');
    expected = ['styles/baz.css', 'js/bar.js', 'js/foo.js', 'styles/qux.css'];
    test.deepEqual(actual, expected, 'if a file is excluded and then re-added, it should be added at the end.');

    actual = globule.find('js/foo.js', '**/*.{js,styles}', '!styles/qux.css', 'styles/qux.css');
    expected = ['js/foo.js', 'styles/baz.css', 'js/bar.js', 'styles/qux.css'];
  ...
  'exclusion': function(test) {
    ...
    test.deepEqual(globule.find(['!js/foo.js', '**/*.js']),
      ['js/bar.js', 'js/foo.js'],
      'inclusion / exclusion order matters');
    test.deepEqual(globule.find(['**/*.js', '**/*.css', '!js/bar.js', '!styles/baz.css']),
      ['js/foo.js','styles/qux.css'],
    ...
    test.deepEqual(globule.find(['js/bar.js', 'js/foo.js', 'styles/baz.css', 'styles/qux.css', '!**/b*.*']),
      ['js/foo.js', 'styles/qux.css'],
      'different pattern for exclusion should still work');
    test.deepEqual(globule.find(['js/bar.js', '!**/b*.*', 'js/foo.js', 'styles/baz.css', 'styles/qux.css']),
      ['js/foo.js', 'styles/baz.css', 'styles/qux.css'],
      'inclusion / exclusion order matters');
    test.done();
  },
